...
export const featurePageContent: Record<FeaturePageSlug, Record<AuthoredLocale, FeaturePageContent>> = {
  ...
  "golden-hour-photography-app": {
    en: {
      ...
      planningSections: [
        { heading: "Separate good timing from good conditions", body: "Golden hour can still fail when the horizon is blocked, clouds are too dense or visibility drops. Solora helps you judge the usable window with sky conditions, not just a countdown." },
        { heading: "Use it with sunrise and sunset prediction", body: "The best low-light sessions often start before sunrise or continue after sunset. Solora connects golden hour, blue hour and twilight so you can plan the full shooting sequence." },
        { heading: "Build a fallback plan", body: "For travel and paid sessions, compare several locations and decide where the light direction, clouds and visibility line up best. That keeps the session from depending on a single viewpoint." },
      ],
    ...
    es: {
      ...
      planningSections: [
        { heading: "Distingue buen horario de buenas condiciones", body: "La hora dorada puede fallar si el horizonte está bloqueado, las nubes son demasiado densas o baja la visibilidad. Solora evalúa la ventana útil con condiciones de cielo, no solo con una cuenta atrás." },
        { heading: "Úsala junto a amanecer y atardecer", body: "Las mejores sesiones de baja luz empiezan antes del amanecer o continúan tras la puesta. Solora conecta hora dorada, hora azul y crepúsculos para planificar la secuencia completa." },
        { heading: "Prepara un plan alternativo", body: "En viajes y sesiones importantes, compara varias ubicaciones y elige donde mejor coincidan dirección de la luz, nubes y visibilidad." },
      ],
      relatedLinks: ["sunrise-sunset-app", "moon-phase-calendar-app", "milky-way-planner"],
    },
    fr: {
  ...
  "moon-phase-calendar-app": {
    en: {
      ...
      planningSections: [
        { heading: "Choose between dark sky and moonlit scenes", body: "A bright Moon can ruin a Milky Way plan but make a landscape easier to expose. Solora shows phase, illumination and timing so you can decide whether moonlight is a feature or a problem." },
        { heading: "Check moonrise and moonset, not only the phase", body: "The same lunar phase can behave very differently depending on when the Moon is above the horizon. Solora keeps rise and set times beside the broader night-sky forecast." },
        { heading: "Use the Moon with eclipse and meteor planning", body: "For lunar eclipses, meteor showers and the 2026 astronomy calendar, moonlight changes what you can see and photograph. This page supports the eclipse cluster by explaining that decision clearly." },
      ],
    ...
    es: {
      ...
      planningSections: [
        { heading: "Elige entre cielo oscuro y escenas con luna", body: "Una Luna brillante puede arruinar un plan de Vía Láctea, pero ayudar a exponer un paisaje. Solora muestra fase, iluminación y horarios para decidir si la luz lunar ayuda o estorba." },
        { heading: "Mira salida y puesta, no solo la fase", body: "La misma fase lunar se comporta distinto según cuándo esté la Luna sobre el horizonte. Solora mantiene salida y puesta junto al contexto de cielo nocturno." },
        { heading: "Conecta Luna, eclipses y meteoros", body: "En eclipses lunares, lluvias de meteoros y calendario astronómico de 2026, la luz lunar cambia lo visible y fotografiable. Esta página refuerza ese contexto para el cluster de eclipses." },
      ],
      relatedLinks: ["milky-way-planner", "aurora-forecast-app", "sunrise-sunset-app"],
    },
    fr: {
  ...
  "aurora-forecast-app": {
    en: {
      ...
      planningSections: [
        { heading: "Treat aurora alerts as a starting point", body: "A strong activity signal still needs darkness, clear sky and a useful northern horizon. Solora combines local weather and sky context so an alert turns into a practical decision." },
        { heading: "Compare locations under pressure", body: "Aurora opportunities can change quickly. Save candidate spots, compare cloud and visibility trends, and choose the place with the best overall window instead of chasing a single number." },
        { heading: "Use moonlight intentionally", body: "Moonlight can reduce contrast in the aurora but also illuminate foregrounds. Pairing aurora planning with the Moon phase calendar gives stronger decisions for photography." },
      ],
    ...
    es: {
      ...
      planningSections: [
        { heading: "Trata las alertas como punto de partida", body: "Una señal fuerte de actividad aún necesita oscuridad, cielo despejado y horizonte norte útil. Solora une meteorología local y contexto del cielo para convertir una alerta en una decisión práctica." },
        { heading: "Compara ubicaciones cuando hay poco margen", body: "Las oportunidades de aurora cambian rápido. Guarda lugares candidatos, compara nubes y visibilidad y elige la mejor ventana global en vez de perseguir un único número." },
        { heading: "Usa la luz lunar de forma intencional", body: "La luna puede reducir contraste en la aurora, pero también iluminar el primer plano. Combinar aurora y calendario lunar mejora las decisiones fotográficas." },
      ],
      relatedLinks: ["milky-way-planner", "moon-phase-calendar-app", "sunrise-sunset-app"],
    },
    fr: {
  ...
  "milky-way-planner": {
    en: {
      ...
      planningSections: [
        { heading: "Start with darkness, then check the sky", body: "Milky Way visibility needs astronomical darkness and low moon interference, but clouds and visibility decide whether the trip is worth it. Solora brings those factors into one planning view." },
        { heading: "Use Moon data as the gatekeeper", body: "The Moon can wash out the galactic core even when timing looks good. Pair the Milky Way planner with moon phase, illumination, rise and set data before choosing a date." },
        { heading: "Plan the whole night, not one timestamp", body: "A useful dark-sky session includes travel time, twilight, the galactic center window, weather trend and backup location. Solora helps structure that full sequence before you leave." },
      ],
    ...
    es: {
      ...
      planningSections: [
        { heading: "Empieza por la oscuridad y valida el cielo", body: "La Vía Láctea necesita oscuridad astronómica y poca interferencia lunar, pero nubes y visibilidad deciden si merece la pena viajar. Solora reúne esos factores en una vista de planificación." },
        { heading: "Usa la Luna como filtro principal", body: "La Luna puede lavar el centro galáctico aunque el horario parezca bueno. Combina el planificador de Vía Láctea con fase, iluminación, salida y puesta lunar antes de elegir fecha." },
        { heading: "Planifica toda la noche, no un instante", body: "Una buena sesión incluye desplazamiento, crepúsculo, ventana del centro galáctico, tendencia meteorológica y ubicación alternativa. Solora ayuda a estructurar esa secuencia." },
      ],
      relatedLinks: ["moon-phase-calendar-app", "aurora-forecast-app", "sunrise-sunset-app"],
    },
    fr: {
