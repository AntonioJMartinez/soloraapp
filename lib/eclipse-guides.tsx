...
const spanishContent: Record<EclipseGuideSlug, EclipseGuideContent> = {
  ...
  "eclipse-solar-2026-burgos": {
    ...
    sections: [
      ...
      { heading: "La ventaja y el reto de Burgos", paragraphs: ["La duración de la totalidad es mayor que en A Coruña, lo que da algo más de tiempo para observar y ejecutar una secuencia fotográfica sencilla.", "Sin embargo, el Sol estará más bajo. Ocho grados permiten margen sobre un horizonte plano, pero cualquier loma, construcción, arbolado o relieve cercano puede restar la totalidad. La exploración del horizonte es tan importante como estar cerca de la línea central."] },
  ...
  "eclipse-solar-2026-palma": {
    ...
    sections: [
      ...
      { heading: "El horizonte es la decisión principal", paragraphs: ["En Palma no basta con una vista general hacia el oeste. A dos grados, una colina lejana, edificios, barcos, bruma marítima o nubes en el horizonte pueden bloquear la totalidad.", "Un horizonte de mar puede ofrecer una línea más limpia, pero hay que confirmar la orientación exacta, el acceso y la seguridad. No todos los puntos de costa miran hacia el azimut necesario."] },
