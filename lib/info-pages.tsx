...
const translations = {
  en: {
    ...
    privacy: {
      ...
      sections: [
        { heading: "This website", paragraphs: ["The Solora website does not currently load Google Analytics, Google Tag Manager, Mixpanel, PostHog, or advertising trackers. It does not currently set analytics or advertising cookies.", "The hosting and network providers used to deliver the site may process ordinary technical logs such as IP address, request time, browser information, and requested URL for security and service operation."] },
        ...
        { heading: "Future website analytics", paragraphs: ["If analytics or advertising tools are added to this website, Solora will update this notice and implement the consent controls required for visitors in Spain, the EEA, the United Kingdom, and other applicable jurisdictions."] },
  ...
  es: {
    ...
    privacy: {
      ...
      sections: [
        { heading: "Esta web", paragraphs: ["La web de Solora no carga actualmente Google Analytics, Google Tag Manager, Mixpanel, PostHog ni rastreadores publicitarios. Tampoco instala cookies analíticas o publicitarias.", "Los proveedores de alojamiento y red pueden tratar registros técnicos ordinarios, como dirección IP, hora de la petición, navegador y URL solicitada, para seguridad y funcionamiento del servicio."] },
        ...
        { heading: "Analítica futura de la web", paragraphs: ["Si se añade analítica o publicidad a esta web, Solora actualizará este aviso e implantará los controles de consentimiento exigibles en España, el EEE, Reino Unido y otras jurisdicciones aplicables."] },
